...
export default function setup(posts) {
    ...
    const header = [
        ...
        { name: 'نام', show: true, value: 'name', order: true},
        { name: 'تاریخ ساخت', show: true, value: 'created_at', order: true},
        { name: ' عکس', show: true, value: 'created_at', order: false},
    ...
    return {filterField, volume, getVolume ,addPerPage , dataTableLength , page  , header , item}
}
