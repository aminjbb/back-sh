...
export default function setup() {
    ...
    const header =ref( [
        ...
        {name:'تاریخ اخرین درخواست' , title:'تاریخ اخرین درخواست',key:'last_request', show:true, align:'center', sortable: false},
        ...
        {name:'وضعیت' , title:'وضعیت' ,key:'status', show:true, align:'center', sortable: false},
        { name: 'عملیات',title: 'عملیات', key:'action', show: true , align:'center', sortable: false, fixed: true},
    ]);
    const requestListHeader =ref( [
        {name:'ردیف', title:'ردیف', key:'row', show:true, align:'center', sortable: false},
        {name:'بخش درخواست' , title:'تاریخ اخرین درخواست',key:'last_request', show:true, align:'center', sortable: false},
        {name:'عنوان درخواست' , title:'نام فروشنده', key:'seller', show:true, align:'center', sortable: false},
        {name:'توضیحات' ,title:'نام فروشگاه', key:'shopping_name', show:true, align:'center', sortable: false},
        {name:'وضعیت' , title:'وضعیت' ,key:'status', show:true, align:'center', sortable: false},
        { name: 'عملیات',title: 'عملیات', key:'action', show: true , align:'center', sortable: false, fixed: true},
    ]);
    ...
    return {pageLength , filterField, dataTableLength , page  , header , loading , sellers , sellerRequests ,
        getSellersRequest , isFilter , isFilterPage , requestListHeader}
}
