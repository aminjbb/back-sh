...
export default function setup() {
    ...
    const imageHeader =ref([
        ...
        {name: 'دستگاه', title: 'دستگاه', show: true, key:'deviceType', align:'center', sortable: false, model:'deviceSelect' },
        {name: 'موقعیت', title: 'موقعیت', show: true , key:'position', align:'center', sortable: false, model:'select'},
