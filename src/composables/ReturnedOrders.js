...
export default function setup() {
    ...
    async function getReturnedOrderList(query) {
        ...
        AxiosMethod.end_point = `returned-orders/crud/index${paramsQuery}`
    ...
    return {pageLength,filterField, returnedOrderList ,addPerPage, getReturnedOrderList, dataTableLength, page, header,loading, shpsModalHeader, discountModalHeader, factorModalHeader, returnedShpsModalHeader}
}
