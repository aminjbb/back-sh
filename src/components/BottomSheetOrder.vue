          ...
          <div>
            <div class="flex-column">
              <div class="d-flex justify-space-between align-center">
                ...
                <div class="">
                  <span class="t12500"> اسنپ پی </span>
              ...
              <div class="d-flex justify-space-between align-center mb-3">
                ...
                <div class="">
                  <span class="t12500"> وضعیت پرداخت </span>
                  <v-icon icon="mdi-circle-small"/>
                </div>
              </div>
              <v-divider class="my-3"/>
              <div class="d-flex justify-space-between align-center mb-3">
                ...
                <div class="">
                  <span class="t12500"> روش پرداخت </span>
                  <v-icon icon="mdi-circle-small"/>
                </div>
              </div>
              <v-divider class="my-3"/>
              ...
              <div class="d-flex justify-space-between align-center mb-3">
                ...
                <div class="">
                  <span class="t12500"> مبلغ پرداختی </span>
                  <v-icon icon="mdi-circle-small"/>
                </div>
              </div>
              <v-divider class="my-3"/>
              <div class="d-flex justify-space-between align-center mb-3">
                ...
                <div class="">
                  <span class="t12500"> وضعیت بارگیری </span>
                  <v-icon icon="mdi-circle-small"/>
                </div>
              </div>
              <v-divider class="my-3"/>
              <div class="d-flex justify-space-between align-center mb-3">
                ...
                <div class="">
                  <span class="t12500"> تاریخ ثبت سفارش </span>
                  <v-icon icon="mdi-circle-small"/>
                </div>
              </div>
              <v-divider class="my-3"/>
              <div class="d-flex justify-space-between align-center mb-3">
                ...
                <div class="">
                  <span class="t12500"> تاریخ ارسال سفارش </span>
                  <v-icon icon="mdi-circle-small"/>
                </div>
              </div>
            </div>
