<template>
  <div :style="{height: height}" class="c-table pl-1">
    ...
    <div class="stretch-table">
      <div v-if=" items&& items.length > 0 && !loading" class="c-table__contents">
        <div
          ...
          <div
            ...
            <span><v-icon color="gray500" class="pointer"  @click="selectFile(index)">mdi-progress-upload</v-icon></span>
          </div>
          ...
          <div
              class="c-table__contents__item justify-center"
              :style="{ width: itemsWidth, flex: `0 0 ${itemsWidth}` }">
            <v-select v-model="form[index].deviceType" hide-details variant="outlined" :items="deviceType  "/>
          </div>
          <div
              class="c-table__contents__item justify-center"
              :style="{ width: itemsWidth, flex: `0 0 ${itemsWidth}` }">
            <v-select v-model="form[index].position" hide-details variant="outlined" :items="positionImageList"/>
          </div>
          <div
              class="c-table__contents__item justify-center"
              :style="{ width: itemsWidth, flex: `0 0 ${itemsWidth}` }">
            <v-text-field  v-model="form[index].priority" hide-details variant="outlined" type="number"/>
          </div>
          <div
              class="c-table__contents__item justify-center"
              :style="{ width: itemsWidth, flex: `0 0 ${itemsWidth}` }">
            <v-progress-circular
                ...
                color="primary"
            ></v-progress-circular>
            <div v-else  @click="updateImage(index)" class="seller__add-sku-btn d-flex justify-center align-center pointer">
                ...
                <v-list-item>
                  <v-list-item-title>
                    <div class="ma-5 pointer" @click="removeItem(`${$route.params.pageId}/${form[index].imageId}` )">
                      <v-icon class="text-grey-darken-1">mdi-trash</v-icon>
      ...
      <div v-else class="null-data-table justify-center" style="top: 50%">
