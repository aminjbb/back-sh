    ...
    <v-row class="pa-2">
        <v-col class="ticket-single__sidebar" md="3">
            <div class="bg-indigo-lighten-5 pa-8 h-100">
                ...
                <div v-if="ticketStatus === 'pending' || ticketStatus === 'open'" class="ticket-single__sidebar__item d-flex align-center ga-3">
                ...
                <v-btn :loading="loading" @click="updateTicket()" color="primary500" height="40" rounded class="px-8 mt-1 w-50">
                    ثبت
                </v-btn>
            </div>
        </v-col>
        ...
        <v-col md="9" class="vh-100">
            <div class="stretch-table">
                <div class="pl-6">
                    <v-card v-if="oneTicket && oneTicket.content" min-height="100" class="mb-10">
                    ...
                    <template v-if="oneTicket && oneTicket.threads">
                        <div v-for="ticket in oneTicket.threads" :key="ticket.creator === 'user' ? `userMessage${ticket.id}` : `adminMessage${ticket.id}`">
                            <v-card min-height="100" class="mb-10" :color="ticket.creator === 'admin' ? 'grey-lighten-3' : ''">
                                <div class="d-flex justify-space-between pa-6">
                    ...
                    <div>
                        ...
                        <v-btn :loading="sendMsgLoading" @click="sendMessage()" color="primary500" height="40" rounded class="px-8 mt-1">
                            ارسال پیام
                        </v-btn>
                    </div>
                </div>
