      ...
      <template v-for="(head, index) in header">
        <div
            ...
            :style="[
                    ...
                    index === 7 ? { width: '4.33333%', flex: '0 0 4.33333%' } : {},
                ]">
      ...
      <div v-if="items && items.length > 0 && !loading" class="c-table__contents">
        <div
          ...
          <div
              v-if="header[2].show"
              class="c-table__contents__item"
              style=" flex: 0 0 15.33333%;padding: 3px 5px;">
                    <span class="t10400text-gray500 py-5 number-font">
              ...
              :style="{ width: itemsWidth, flex: `0 0 ${itemsWidth}` }">
                    <span class="t12500text-gray500 py-5 number-font">
                        <template v-if="item.shipment_type">
                            {{getShipmentType(item.shipment_id)}}
                        </template>
                        <template v-else>
                            -
                        </template>
