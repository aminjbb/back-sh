        ...
        <v-row justify="start" align="start" class="px-10 py-5">
            <v-col cols="12" md="6">
                <v-form @submit.prevent="onFormSubmit" v-model="valid">
                    <div>
                        <v-text-field :autofocus="true" variant="outlined" :rules="rule" v-model="cargoId" placeholder="شناسه سفارش را اسکن نمایید" />
                    </div>
                </v-form>
            </v-col>
            ...
            <v-row class="pr-5">
                ...
                <v-col cols="6">
                    <div class="text-center">
                        <v-pagination v-model="pageNumber" :length="pageLength" rounded="circle" size="40" :total-visible="7" prev-icon="mdi-chevron-right" next-icon="mdi-chevron-left" />
                    </div>
                </v-col>
