                ...
                <div class="pa-4">
                    <div v-if="calculatedData !== null" class="modal__content modal__content--cols d--rtl py-3 px-4 d-flex justify-star align-center">
                        ...
                        <div class="d-flex justify-star align-center pa-2">
                            ...
                            <span v-if="calculatedData.marketing_discount_start_time !== null" class="modal__content__txt number-font">{{calculatedData.marketing_discount_start_time}}</span>
                        </div>
    
                        <div class="d-flex justify-star align-center pa-2">
                            <span class="modal__content__title">زمان پایان تخفیف مارکتینگ : </span>
                            <span v-if="calculatedData.marketing_discount_end_time !== null" class="modal__content__txt number-font">{{calculatedData.marketing_discount_end_time}}</span>
                        </div>
                    </div>
                    ...
                    <div v-else class="modal__content modal__content--cols d--rtl py-3 px-4 d-flex justify-star align-center">
                        ...
                        <div class="d-flex justify-star align-center pa-2">
                            <span class="modal__content__title">زمان شروع تخفیف مارکتینگ: </span>
                            <span v-if="data && data.marketing_discount_start_time !== null" class="modal__content__txt number-font">{{data.marketing_discount_start_time}}</span>
                        </div>
    
                        <div class="d-flex justify-star align-center pa-2">
                            <span class="modal__content__title">زمان پایان تخفیف مارکتینگ : </span>
                            <span v-if="data && data.marketing_discount_end_time !== null" class="modal__content__txt number-font">{{data.marketing_discount_end_time}}</span>
                        </div>
                    </div>
                </div>
