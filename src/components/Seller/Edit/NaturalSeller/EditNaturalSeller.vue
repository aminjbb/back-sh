  ...
  <section class="create-product flex-column d-flex h-100">
    ...
    <v-card class="ma-5 br--12 pb-15 flex-grow-1">
      ...
      <template v-if="step === 2">
        <EditNaturalSellerStep2 :seller="seller" ref="step2"/>
      </template>
      <template v-if="step === 3">
        <EditNaturalSellerStep3 :seller="seller" ref="step3"/>
      </template>
...
export default {
  ...
  components: {
    EditNaturalSellerStep1,
    EditNaturalSellerStep2,
    EditNaturalSellerStep3,
    Stepper
  },
  ...
  methods: {
    ...
    async updateSeller() {
      ...
      if (data) {
        ...
        if (form1.logoIdDeleted){
          this.deleteImage(form1.logoIdDeleted)
        }
