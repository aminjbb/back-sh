  ...
  export default {
    ...
    methods: {
      print() {
        ...
        // this.close()
        window.open(`${ import.meta.env.VITE_API_SITEURL}processing-shipment/${this.shipmentId}/${this.shpsId}/${this.packageId}/${this.placerId}/initial-barcode-print`, '_blank');
