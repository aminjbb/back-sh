<template>
  <v-card class="h-100 width-100 position__relative">
    ...
    <v-card class="mx-5 mb-1 br-15 pa-2">
      ...
      <!--      -->
      <!--      -->
      <!--      <v-text-field @keyup.enter="scanQrCode()" :autofocus="true" v-model="shpssBarCode"-->
      ...
      <div v-else>
        <div class="px-5">
          <v-card min-height="92" class="d-flex justify-center align-center">
            <v-card class="ml-5 br br--12 d-flex justify-center align-center" height="52" width="52" color="primary500">
