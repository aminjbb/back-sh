<template>
  <div class="h-100 d-flex flex-column align-stretch sku-seller">
    ...
    <v-card height="70" class="ma-5 br-12 stretch-card-header-70" min-height="100">
      <v-row
          justify="center"
          align="center"
          class="px-10 py-5">
...
export default {
  setup(props) {
    ...
    const {
      getHomeSection , homeSection , homePageSkuHeader
    } = new Home()
    return {
      getSkuSeller , sellerSku,headerSku,filterFieldSku,addSkuPerPage , pageLength,
      skuPage ,dataSkuTableLength ,  getHomeSection , homeSection  , homePageSkuHeader
    };
  },
