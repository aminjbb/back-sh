    ...
    >
      <div   class="create-form__info-form scroller">
       ...
       <span class="t14500">
        ...
        <div>
          <AddAdsBanner :banners="desktopBanner" :max="homeSection?.max" device="desktop"/>
        </div>
        <div class="text-right pa-10">
       <span class="t14500">
         تبلت
        ...
        <div>
          <AddAdsBanner :banners="tabletBanner" :max="homeSection?.max" device="tablet"/>
        </div>
        <div class="text-right pa-10">
       <span class="t14500">
         موبایل
        ...
        <div>
          <AddAdsBanner :banners="mobileBanner" :max="homeSection?.max" device="mobile"/>
        </div>
      </div>
...
export default {
  ...
  setup(){
    const {
      getHomeSection , homeSection , getHomePageBanner ,homePageBanner
    } = new Home()
    return {
      getHomeSection , homeSection , getHomePageBanner ,homePageBanner
    }
