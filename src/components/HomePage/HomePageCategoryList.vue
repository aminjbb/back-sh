...
export default {
  setup(props) {
    const {
      bannerHeader , getHomeSection ,getHomePageBanner,homePageBanner, homeSection ,  dataTableLength, page , filterBannerField , loading ,
    } = new Home();
    return {
      bannerHeader , getHomeSection , homeSection ,getHomePageBanner,homePageBanner,  dataTableLength, page , filterBannerField , loading
    };
  },
  data(){
    return{
