...
export default {
  setup(props) {
    ...
    const {
      getHomeSection , homeSection , homePageSkuHeader , getHomeSinglePartitionSlider , homeSinglePartitionSlider
    } = new Home()
    return {
      getSkuSeller , sellerSku,headerSku,filterFieldSku,addSkuPerPage , pageLength,
      skuPage ,dataSkuTableLength ,  getHomeSection , homeSection  , homePageSkuHeader , getHomeSinglePartitionSlider , homeSinglePartitionSlider
    };
  },
