                ...
                <div :style="{ width: itemsWidth, flex: `0 0 ${itemsWidth}` }" class="c-table__contents__item">
                    <v-menu :location="location">
                        ...
                        <v-list class="c-table__more-options">
                            ...
                            <v-list-item>
                                <v-list-item-title>
                                    <div class="ma-5 pointer" @click="$router.push(`/home-page/${$route.params.sectionId}/section-sku/${item.id}/add/sku`)">
                                        <span class="mr-2 text-grey-darken-1 t14 w300">
                                            مدیریت کالا ها
                                        </span>
                                    </div>
...
export default {
    ...
    methods: {
        ...
        async update(index, item) {
            ...
            AxiosMethod.end_point = `page/home/section/category/update/${item.id}`
