...
export default {
    ...
    setup(props) {
        const { pageLength, notifications, addPerPage, getNotifications, dataTableLength, page, header, item ,loading} = Notifications();
        return { pageLength, notifications, addPerPage, getNotifications, dataTableLength, page, header, item,loading};
    },
