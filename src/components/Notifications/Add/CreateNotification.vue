                        ...
                        >
                            <v-col cols="3">
                                <div class="d-flex align-center">
                                    ...
                                    <v-checkbox v-model="hasSchedule" />
                               </div>
                            </v-col>
                            ...
                            >
                                ...
                                <date-picker  
                                    ...
                                    display-format="jYYYY-jMM-jDD"  v-model="form.scheduleDate"
                                />
                            </v-col>
                        </v-row>
                    </v-col>
                        ...
                        >
                            <v-col cols="3">
                                <div class="d-flex align-center">
                                    ...
                                    <v-checkbox v-model="hasAttachment" />
                               </div>
                            </v-col>
...
export default {
    ...
    data: () => ({
        ...
        priority: [
            { value: 'low', title: 'پایین' },
            { value: 'normal', title: 'عادی' },
            { value: 'high', title: 'بالا' },
        ],
        typeMessages: [
            { value: 'alarm', title: 'هشدار' },
            { value: 'message', title: 'پیام' },
            { value: 'news', title: 'خبری' },
            { value: 'general', title: 'عمومی' },
    ...
    mounted() {
        ...
        this.getAdmins(this.$cookies.get('adminToken'), filter)
    }
}
</script>
