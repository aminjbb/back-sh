...
// const CancelOrder = defineAsyncComponent(()=> import ('@/components/Orders/CancelOrder/CancelOrder.vue'))
...
export default {
  components: {SaveModal, CancelOrderTable, ConfirmCancelOrder, DashboardLayout, Header},
  setup() {
    const {
      headerCanselOrder,
    } = Orders();
