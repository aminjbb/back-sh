...
// const CargoPackage = defineAsyncComponent(()=> import ('@/components/Cargo/CargoPackage.vue'))
...
export default {
  ...
  setup() {
    const { getCargo , cargo ,packageHeader ,  getPackageCargo , packageCargo } = Cargo();
    return { getCargo , cargo ,packageHeader ,  getPackageCargo , packageCargo };
  },
