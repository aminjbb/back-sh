  ...
  <v-layout class="bg-gray">
    ...
    <v-main class="h-100vh">
      ...
      <div class="chat-page">
        <v-row>
          <v-col cols="3">
            <ChatList :getConversation="getConversation" :userList="userConversationList"
          ...
          <v-col cols="9">
            <div class="pl-5">
              <v-card class="ma-5 br-12 chat-page__message-list ma-0">
                <MessageList :getConversationList="getConversationList" :getConversation="getConversation"
                             :conversation="conversation" :conversationMessages="conversationMessages"/>
              </v-card>
            </div>
          </v-col>
        </v-row>
...
const MessageList = defineAsyncComponent(() => import ('@/components/Chat/MessageList/MessageList.vue'))
