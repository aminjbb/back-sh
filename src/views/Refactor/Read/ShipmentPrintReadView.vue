                ...
                <v-card class=" " height="180">
                  <div class="d-flex justify-center align-center px-10 ma-5">
                    <div class="mx-10 d--rtl">
                      ...
                      <div>{{ retailObject?.barcode }}</div>
                    </div>
                  </div>
                  <div class="d-flex justify-space-between align-center px-10 ma-5">
                    <div class="mx-10 d--rtl">
                      <span style="font-size: 7px">شناسه محموله :</span>
                      <span style="font-size: 7px">{{ retailObject?.id }}</span>
                    </div>
                    <div class="mx-10 d--rtl">
                      <span style="font-size: 7px">تامین کننده :</span>
                      <span style="font-size: 7px">{{ retailObject?.factor?.supplier?.shopping_name }}</span>
                    </div>
                    <div class="mx-10 d--rtl">
                      <span style="font-size: 7px">شناسه فاکتور </span>
                      <span style="font-size: 9px">{{ retailObject?.factor_id }}</span>
                    </div>
                    <div class="mx-10 d--rtl">
                      <span style="font-size: 7px">تاریخ تحویل :</span>
...
export default {
    setup() {
      const {headerShps} = RetailShipment();
