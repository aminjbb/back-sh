...
export default {
  ...
  methods: {
    async getOrderListDetail() {
      ...
      AxiosMethod.end_point = `admin/campaign/post-print/bulk?count=${this.$route.params.count}`
      // AxiosMethod.end_point = `admin/campaign/post-print/single/${this.$route.params.orderId}`;
      try {
