...
<script>
import DetailCustomerVoucher from '@/components/Voucher/DetailCustomerVoucher.vue'
import DetailCustomerVoucherMobile from '@/components/Voucher/Mobile/DetailCustomerVoucherMobile.vue'
